  ...
  return (
    ...
    >
      <g>
        ...
        <g>
          <path
            className="sharpener1"
            d="M24,13.2L24,13.2c-5.4,0-9.8,4.4-9.8,9.7v56.5h19.5V23C33.7,17.6,29.4,13.2,24,13.2z"
          ></path>
          <path
            className="sharpener2"
            d="M24,13.2c-5.4,0-9.8,4.4-9.8,9.8v56.5h11V13.3C24.8,13.3,24.4,13.2,24,13.2z"
          ></path>
          <path
            className="sharpener3"
            d="M28.4,14.3c-1-0.5-2-0.8-3.2-1v66.2h3.2V14.3z"
          ></path>
          <g>
            <circle className="sharpener0" cx="19.6" cy="45.2" r="3.6"></circle>
            <path
              className="sharpener1"
